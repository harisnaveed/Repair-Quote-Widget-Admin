...
Route::middleware('auth:web')->group(function () {
    ...
    Route::get('/locations', [LocationController::class, 'myLocations'])
        ->name('locations.index');
    Route::get('/location/{location}/view', [LocationController::class, 'viewLocation'])
        ->name('location.view');
    Route::put('/location/{location}/toggle-status', [LocationController::class, 'toggleStatus'])
        ->name('location.toggle-status');
});
