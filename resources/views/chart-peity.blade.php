...
@section('content')
		<div class="content-body">
			<div class="page-titles">
				<h5 class="dashboard_bar">Peity Chart</h5>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="{{ url('index') }}">
							Home </a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0)">Peity Chart</a></li>
				</ul>
			</div>
			<div class="container">
				<!-- row -->
				...
				<div class="row">
										...
										<div class=" row">
											<div class="col-md-2 col-sm-4 col-6">
												<span class="data-attr"
													data-peity='{ "fill": ["rgb(29, 105, 214)", "rgba(29, 105, 214,1)"], "innerRadius": 10, "radius": 40 }'>1/7</span>
											</div>
								...
								<div class="row">
									<div class="col-lg-4 col-md-4 pb-4">
										...
										<div class="px-4"><span class="bar"
												data-peity='{ "fill": ["rgb(29, 105, 214)", "rgba(29, 105, 214,1)"]}'>6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
										</div>
									</div>
									<div class="col-lg-4 col-md-4 pb-4">
										<h4 class="card-title mb-4">Bar Chart</h4>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-4">
										<h4 class="card-title mb-4">Pie 1</h4>
										<div class=""><span class="pie"
												data-peity='{ "fill": ["#0000", "rgba(244, 67, 54, 1)"]}'>5/8</span>
										</div>
									</div>
									<div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-4">
								...
								<div class="row">
									<div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-4">
										...
										<div class=""><span class="donut"
												data-peity='{ "fill": ["rgb(29, 105, 214)", "rgba(185,168,255,1)"]}'>5/8</span>
										</div>
									</div>
									<div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-4">
									...
									<div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-4">
										...
										<div class=""><span class="donut"
												data-peity='{ "fill": ["#24365c", "rgba(185,168,255,1)"]}'>0.52,1.041</span>
										</div>
									</div>
								</div>
							</div>
