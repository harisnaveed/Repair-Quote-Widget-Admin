...
@section('content')
        <div class="content-body">
			<div class="page-titles">
				<h5 class="dashboard_bar">Basic Bootstrap Table</h5>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="{{ url('index') }}">
						Home </a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0)">Basic Bootstrap Table</a></li>
				</ul>
			</div>
            <!-- container starts -->
            <div class="container">
				...
				<div class="element-wrapper">
					<div class="element-right">
						<div class="p-4 border-bottom">
							...
							<a href="javascript:void(0);" class="btn btn-primary">Bootstrap Table</a>
						</div>	 
