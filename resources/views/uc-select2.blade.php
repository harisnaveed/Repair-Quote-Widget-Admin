...
@section('content')
        <div class="content-body">
			<div class="page-titles">
				<h5 class="dashboard_bar">Select 2</h5>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="{{ url('index') }}">
						Home </a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0)">Select 2</a></li>
				</ul>
			</div>
            <div class="container">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <p>Select2 also supports multi-value select boxes. The select below is declared with the multiple <mark class="text-black">attribute</mark>.</p>
                                </div>
