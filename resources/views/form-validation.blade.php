...
@section('content')
        <div class="content-body">
			<div class="page-titles">
				<h5 class="dashboard_bar">Form Validation</h5>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="{{ url('index') }}">
						Home </a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0)">Form Validation</a></li>
				</ul>
			</div>
            <div class="container">
                <!-- row -->
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form class="form-valide-with-icon needs-validation" novalidate>
                                        ...
                                        <div class="mb-3">
                                            <label class="text-label form-label" for="dz-password">Password <span class="text-danger"> *</span></label>
