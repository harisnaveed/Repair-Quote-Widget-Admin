...
@section('content')
        <div class="content-body">
			<div class="page-titles">
				<h5 class="dashboard_bar">Form Element</h5>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="{{ url('index') }}">
						Home </a>
					</li>
					<li class="breadcrumb-item active"><a href="javascript:void(0)">Form Element</a></li>
				</ul>
			</div>
            <div class="container">
                <!-- row -->
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form>
                                        ...
                                        <div class="mb-3 row">
                                            <label class=" col-form-label col-2 my-auto">Password</label>
											<div class="col-10">
