...
@section('content')
		<div class="content-body crm-main">
			<div class="container">
				<div class="row">
								...
								<div class="progress-box mt-0">
									...
									<div class="progress">
										<div class="progress-bar bg-primary"
											style="width:50%; height:10px; border-radius:4px;" role="progressbar"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-xl-4 col-lg-6 same-card">
						<div class="card">
													...
													<div class="d-items-3">
														...
														<div>
															<div class="form-check custom-checkbox">
																...
																<label class="form-check-label"
																	for="customCheckBox02">Projects Done
																	Monday</label>
															</div>
															<span>2023-12-26 07:15:00</span>
														</div>
													...
													<div class="d-items-3">
														...
														<div>
															<div class="form-check custom-checkbox">
																...
																<label class="form-check-label"
																	for="customCheckBox03">Task Done
																	Monday</label>
															</div>
															<span>2023-12-26 07:15:00</span>
														</div>
													...
													<div class="d-items-3">
														...
														<div>
															<div class="form-check custom-checkbox">
																...
																<label class="form-check-label"
																	for="customCheckBox5">CSS Runnng
																	Monday</label>
															</div>
															<span>2023-12-26 07:15:00</span>
														</div>
