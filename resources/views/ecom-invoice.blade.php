			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="card mt-3">
							<div class="card-header"> Invoice <strong>01/03/2024</strong> <span class="float-end">
							...
							<div class="card-body">
								<div class="row mb-5">
									...
									<div
										class="mt-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex justify-content-lg-end  justify-content-xs-start">
										<div class="row align-items-center">
											<div class="col-sm-9">
												<div class="brand-logo mb-3">
													<img src="{{ asset('images/logo-full.png') }}" class="mb-3" alt="">
												</div>
									...
									<div class="col-lg-4 col-sm-5 ms-auto">
										<table class="table table-clear">
											<tbody>
												...
												<tr>
													<td class="left"><strong class="text-dark">Discount (20%)</strong>
													</td>
												...
												<tr>
													...
													<td class="right"><strong class="text-dark">$7.477,36</strong><br>
														<strong class="text-dark">0.15050000 BTC</strong>
													</td>
												</tr>
											</tbody>
										</table>
