<div class="deznav">
  <div class="deznav-scroll grid-menu">
    <ul class="metismenu" id="menu">
      <li><a href="{{ route('platform.dashboard') }}" class="" aria-expanded="false">
          <div class="menu-icon">
      ...
      <li><a href="{{ route('platform.companies') }}" class="" aria-expanded="false">
          <div class="menu-icon">
      ...
      <li><a href="{{ url('/staff') }}" class="" aria-expanded="false">
          ...
          <span class="nav-text">Staff</span>
                ...
                <li><a href="{{ url('/leads') }}" class="" aria-expanded="false">
          <div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
              width="24px" fill="#5f6368">
              <path
          ...
          <span class="nav-text">Leads</span>
                ...
                <li><a href="{{ url('/categories') }}" class="" aria-expanded="false">
          <div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
              width="24px" fill="#5f6368">
              <path
          ...
          <span class="nav-text">Categories</span>
                ...
                <li><a href="{{ url('/brands') }}" class="" aria-expanded="false">
          <div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
              width="24px" fill="#5f6368">
              <path
          ...
          <span class="nav-text">Brands</span>
                ...
                <li><a href="{{ url('/devices') }}" class="" aria-expanded="false">
          <div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
              width="24px" fill="#5f6368">
              <path
          ...
          <span class="nav-text">Devices</span>
                ...
                <li><a href="{{ url('/repair-issues') }}" class="" aria-expanded="false">
          <div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
              width="24px" fill="#5f6368">
              <path
          ...
          <span class="nav-text">Repair Issues</span>
        </a>
      </li>
                <li><a href="{{ url('/repair-issues') }}" class="" aria-expanded="false">
          <div class="menu-icon">
      ...
      <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
        ...
        <ul aria-expanded="false">
          <li><a href="{{ url('profile/overview-profile') }}">Overview</a></li>
          <li><a href="{{ url('profile/projects') }}">Projects</a></li>
          <li><a href="{{ url('profile/projects-details') }}">Projects Details</a></li>
          <li><a href="{{ url('profile/campaigns') }}">Campaigns</a></li>
          <li><a href="{{ url('profile/documents') }}">Documents</a></li>
          <li><a href="{{ url('profile/followers') }}">Followers</a></li>
          <li><a href="{{ url('profile/activity-profile') }}">Activity</a></li>
        </ul>
      </li>
      <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
          <div class="menu-icon">
        ...
        <ul aria-expanded="false">
          <li><a href="{{ url('account/overview') }}">Overview</a></li>
          <li><a href="{{ url('account/settings') }}">Settings</a></li>
          <li><a href="{{ url('account/security') }}">Security</a></li>
          <li><a href="{{ url('account/activity') }}">Activity</a></li>
          <li><a href="{{ url('account/billing') }}">Billing</a></li>
          <li><a href="{{ url('account/statements') }}">Statements</a></li>
          <li><a href="{{ url('account/referrals') }}">Referrals</a></li>
          <li><a href="{{ url('account/api-keys') }}">Api keys</a></li>
      ...
      <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
          <div class="menu-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M2.67673 5.387C2.44501 5.387 2.25135 5.30882 2.09573 5.15247C1.94011 4.99612 1.8623 4.80238 1.8623 4.57125V1.71417C1.8623 1.47377 1.94414 1.27174 2.1078 1.10807C2.27149 0.94439 2.47353 0.862549 2.71393 0.862549H5.571C5.80214 0.862549 5.99588 0.941816 6.15223 1.10035C6.30858 1.2589 6.38675 1.45402 6.38675 1.68572C6.38675 1.91744 6.30858 2.11109 6.15223 2.26667C5.99588 2.42226 5.80214 2.50005 5.571 2.50005H3.4998
 8.22015H9.9998C9.78052 8.22015 9.59671 8.29527 9.44838 8.4455C9.30005 8.59572 9.22588 8.78185 9.22588 9.0039C9.22588 9.22597 9.29975 9.40982 9.4475 9.55547C9.59524 9.70114 9.77934 9.77397 9.9998 9.77397ZM9.9998 12.774H13.9998C14.2185 12.774 14.4031 12.6996 14.5538 12.5509C14.7044 12.4021 14.7797 12.2178 14.7797 11.998C14.7797 11.7764 14.7044 11.5914 14.5538 11.4429C14.4033 11.2944 14.2186 11.2201 13.9998 11.2201H9.9998C9.78052 11.2201 9.59671 11.2953 9.44838 11.4455C9.30005 11.5957 9.22588 11.7818 9.22588 12.0039C9.22588 12.226 9.29975 12.4098 9.4475 12.5555C9.59524 12.7011 9.77934 12.774 9.9998 12.774ZM9.9998 15.774H13.9998C14.2185 15.774 14.4031 15.6996 14.5538 15.5509C14.7044 15.4021 14.7797 15.2178 14.7797 14.998C14.7797 14.7764 14.7044 14.5914 14.5538 14.4429C14.4033 14.2944 14.2186 14.2201 13.9998 14.2201H9.9998C9.78052 14.2201 9.59671 14.2953 9.44838 14.4455C9.30005 14.5957 9.22588 14.7818 9.22588 15.0039C9.22588 15.226 9.29975 15.4098 9.4475 15.5555C9.59524 15.7011 9.77934 15.774 9.9998 15.774Z"
                fill="#6F767E" />
            </svg>
      ...
      <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
        ...
        <ul aria-expanded="false">
          <li><a href="{{ url('aikit/auto-write') }}">Auto Write</a></li>
          <li><a href="{{ url('aikit/scheduled') }}">Scheduled</a></li>
          <li><a href="{{ url('aikit/repurpose') }}">Repurpose</a></li>
          <li><a href="{{ url('aikit/rss') }}">RSS</a></li>
          <li><a href="{{ url('aikit/chatbot') }}">Chatbot</a></li>
          <li><a href="{{ url('aikit/fine-tune-models') }}">Fine Tune Models</a></li>
          <li><a href="{{ url('aikit/prompt') }}">Prompt</a></li>
          <li><a href="{{ url('aikit/setting') }}">Setting</a></li>
          <li><a href="{{ url('aikit/import') }}">Import</a></li>
        </ul>
      </li>
      <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
          <div class="menu-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M5.5739 17.5592C6.6199 16.8339 7.65757 16.2774 8.68692 15.8897C9.71627 15.502 10.8215 15.3081 12.0026 15.3081C13.1837 15.3081 14.294 15.5035 15.3336 15.8943C16.3732 16.285 17.4124 16.84 18.451 17.5592C19.1764 16.6552 19.6903 15.754 19.9926 14.8554C20.295 13.9569 20.4462 13.005 20.4462 12C20.4462 9.60228 19.638 7.59514 18.0217 5.97859C16.4053 4.36206 14.3985 3.55379 12.001 3.55379C9.60359 3.55379 7.59636 4.36206 5.97932 5.97859C4.36229 7.59514 3.55377 9.60228 3.55377 12C3.55377 13.0047 3.70817 13.9559 4.01697 14.8535C4.32579 15.7511 4.84477 16.653 5.5739 17.5592ZM11.9953 12.7918C11.0192 12.7918 10.1991 12.4581 9.5351 11.7907C8.8711 11.1233 8.5391 10.3029 8.5391 9.32932C8.5391 8.35578 8.87265 7.53587 9.53975 6.86957C10.2069 6.20325 11.0285 5.87009 12.0046 5.87009C12.9808 5.87009 13.8008 6.2048 14.4648 6.87422C15.1288 7.54362 15.4608 8.36509 15.4608 9.33862C15.4608 10.3122 15.1273 11.1311 14.4602 11.7954C13.7931 12.4597 12.9715 12.7918 11.9953 12.7918ZM12.0082 22.1494C10.6161 22.1494 9.303 21.8834 8.06885 21.3512C6.8347 20.8191 5.75587 20.0913 4.83235 19.1679C3.90885 18.2445 3.181 17.1675 2.6488 15.9371C2.11662 14.7066 1.85052 13.3919 1.85052 11.9928C1.85052 10.5983 2.11701 9.28694 2.64997 8.05869C3.18294 6.83043 3.91057 5.75515 4.83285 4.83287C5.75513 3.91059 6.83161 3.18196 8.06227 2.64699C9.29292 2.11203 10.6079 1.84454 12.0071 1.84454C13.4016 1.84454 14.713 2.11203 15.9413 2.64699C17.1695 3.18196 18.2448 3.91059 19.1671 4.83287C20.0894 5.75515 20.818 6.83086 21.353 8.05999C21.8879 9.28911 22.1554 10.5997 22.1554 11.9918C22.1554 13.3839 21.8879 14.6972 21.353 15.9318C20.818 17.1664 20.0894 18.2448 19.1671 19.1671C18.2448 20.0894 17.1691 20.817 15.94 21.35C14.7109 21.883 13.4003 22.1494 12.0082 22.1494ZM12 20.4462C12.9047 20.4462 13.7846 20.3168 14.6396 20.0581C15.4947 19.7994 16.3473 19.3427 17.1973 18.688C16.3433 18.092 15.4866 17.6407 14.6271 17.334C13.7677 17.0273 12.892 16.8739 12 16.8739C11.1079 16.8739 10.2332 17.0273 9.3758 17.334C8.51837 17.6407 7.66266 18.092 6.80867 18.688C7.65867 19.3427 8.51022 19.7994 9.3633 20.0581C10.2164 20.3168 11.0953 20.4462 12 20.4462ZM12 11.2201C12.5542 11.2201 13.0076 11.0449 13.3602 10.6946C13.7128 10.3442 13.8891 9.89067 13.8891 9.33397C13.8891 8.77727 13.7128 8.32274 13.3602 7.97037C13.0076 7.61802 12.5542 7.44184 12 7.44184C11.4458 7.44184 10.9924 7.61802 10.6398 7.97037C10.2872 8.32274 10.1109 8.77727 10.1109 9.33397C10.1109 9.89067 10.2872 10.3442 10.6398 10.6946C10.9924 11.0449 11.4458 11.2201 12 11.2201Z"
                fill="#6F767E" />
            </svg>
          </div>
        ...
        <ul aria-expanded="false">
          ...
          <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">Ecommerce
            </a>
            <ul aria-expanded="false">
              <li><a class="has-arrow" href="javascript:void(0);"
                  aria-expanded="false">Categories</a>
                <ul aria-expanded="false">
                  <li><a href="{{ url('category-table') }}">Category Table</a></li>
                  <li><a href="{{ url('add-categary') }}">Add Category</a></li>
                  <li><a href="{{ url('edit-categary') }}">Edit Category</a></li>
                </ul>
              </li>
              ...
              <li><a class="has-arrow" href="javascript:void(0);"
                ...
                <ul aria-expanded="false">
                  <li><a href="{{ url('product-table') }}">Product Table</a></li>
      ...
      <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
          <div class="menu-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M12 20.1381C11.7554 20.1381 11.5192 20.0904 11.2913 19.9951C11.0634 19.8998 10.8645 19.7486 10.6945 19.5413L2.63693 9.8636C2.42171 9.59837 2.29445 9.29999 2.25515 8.96848C2.21582 8.63696 2.27279 8.31793 2.42608 8.0114L4.47933 3.86685C4.62859 3.58497 4.84 3.35906 5.11355 3.18913C5.38712 3.01921 5.68549 2.93425 6.00868 2.93425H17.9913C18.3145 2.93425 18.6128 3.01921 18.8864 3.18913C19.16 3.35906 19.3734 3.58497 19.5266 3.86685L21.5739 8.0114C21.7271 8.31793 21.7841 8.63696 21.7448 8.96848C21.7055 9.29999 21.5802 9.59837 21.369 9.8636L13.3054 19.5413C13.1355 19.7486 12.9366 19.8998 12.7087 19.9951C12.4808 20.0904 12.2445 20.1381 12 20.1381ZM8.944 8.25H15.056L13.2109 4.56575H10.7891L8.944 8.25ZM11.25 17.6674V9.75H4.66465L11.25 17.6674ZM12.75 17.6674L19.3353 9.75H12.75V17.6674ZM16.7369 8.25H19.7973L17.9331 4.56575H14.8918L16.7369 8.25ZM4.2027 8.25H7.269L9.10813 4.56575H6.06683L4.2027 8.25Z"
                fill="#6F767E" />
            </svg>
          </div>
        ...
        <ul aria-expanded="false">
          ...
          <li class="extra-menu-li">
            <ul id="collapseExample" class="pt-0 extra-menu-links extra-menu-area">
              ...
              <li><a href="{{ url('ui-offcanvas') }}">Offcanvas</a></li>
              <li><a href="{{ url('ui-popover') }}">Popover</a></li>
              <li><a href="{{ url('ui-breadcrumb') }}">Breadcrumb</a></li>
              ...
              <li><a href="{{ url('ui-toasts') }}">Toasts</a></li>
              <li><a href="{{ url('ui-spinners') }}">Spinners</a></li>
              <li><a href="{{ url('ui-scrollspy') }}">Scrollspy</a></li>
              <li><a href="{{ url('ui-range-slider') }}">Range Slider</a></li>
              <li><a href="{{ url('ui-placeholder') }}">Placeholder</a></li>
              <li><a href="{{ url('ui-object-fit') }}">Object Fit</a></li>
              <li><a href="{{ url('ui-colors') }}">Colors</a></li>
              <li><a href="{{ url('ui-navbar') }}">Navbar</a></li>
      ...
      <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
          <div class="menu-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M8.76085 17.762H15.2451C15.466 17.762 15.6513 17.6863 15.8007 17.535C15.9502 17.3836 16.025 17.1961 16.025 16.9723C16.025 16.7503 15.9502 16.5654 15.8007 16.4177C15.6513 16.27 15.466 16.1962 15.2451 16.1962H8.75488C8.53391 16.1962 8.34868 16.2713 8.1992 16.4215C8.04972 16.5717 7.97498 16.7579 7.97498 16.98C7.97498 17.202 8.05029 17.3879 8.20092 17.5375C8.35154 17.6871 8.53818 17.762 8.76085 17.762ZM8.76085 13.512H15.2451C15.466 13.512 15.6513 13.4363 15.8007 13.285C15.9502 13.1336 16.025 12.9461 16.025 12.7223C16.025 12.5003 15.9502 12.3154 15.8007 12.1677C15.6513 12.02 15.466 11.9462 15.2451 11.9462H8.75488C8.53391 11.9462 8.34868 12.0213 8.1992 12.1715C8.04972 12.3217 7.97498 12.5079 7.
6.30876 22.7485 6.15241 22.9041C5.99606 23.0597 5.80232 23.1375 5.57119 23.1375H2.71411ZM18.4288 23.1375C18.1977 23.1375 18.0039 23.0582 17.8476 22.8997C17.6912 22.7412 17.613 22.546 17.613 22.3143C17.613 22.0826 17.6912 21.889 17.8476 21.7334C18.0039 21.5778 18.1977 21.5 18.4288 21.5H20.5V19.4288C20.5 19.1977 20.5789 19.0039 20.7366 18.8476C20.8944 18.6912 21.0899 18.6131 21.3231 18.6131C21.5548 18.6131 21.7484 18.6912 21.9041 18.8476C22.0597 19.0039 22.1375 19.1977 22.1375 19.4288V22.2859C22.1375 22.5263 22.0556 22.7283 21.892 22.892C21.7283 23.0557 21.5263 23.1375 21.2859 23.1375H18.4288ZM6.63749 18.3625H17.3625V5.6375H6.63749V18.3625ZM6.63749 20.0658C6.18547 20.0658 5.78859 19.8949 5.44684 19.5532C5.1051 19.2114 4.93424 18.8145 4.93424 18.3625V5.6375C4.93424 5.18549 5.1051 4.7886 5.44684 4.44685C5.78859 4.10512 6.18547 3.93425 6.63749 3.93425H17.3625C17.8145 3.93425 18.2114 4.10512 18.5531 4.44685C18.8949 4.7886 19.0657 5.18549 19.0657 5.6375V18.3625C19.0657 18.8145 18.8949 19.2114 18.5531 19.5532C18.2114 19.8949 17.8145 20.0658 17.3625 20.0658H6.63749ZM9.99999 9.77393H14C14.2187 9.77393 14.4033 9.69956 14.5539 9.55083C14.7046 9.4021 14.7799 9.21779 14.7799 8.99793C14.7799 8.77636 14.7046 8.59134 14.554 8.44285C14.4034 8.29435 14.2188 8.2201 14 8.2201H9.99999C9.7807 8.2201 9.5969 8.29522 9.44856 8.44545C9.30023 8.59567 9.22606 8.7818 9.22606 9.00385C9.22606 9.22592 9.29994 9.40978 9.44769 9.55543C9.59542 9.70109 9.77952 9.77393 9.99999 9.77393ZM9.99999 12.7739H14C14.2187 12.7739 14.4033 12.6996 14.5539 12.5508C14.7046 12.4021 14.7799 12.2178 14.7799 11.9979C14.7799 11.7764 14.7046 11.5913 14.554 11.4429C14.4034 11.2944 14.2188 11.2201 14 11.2201H9.99999C9.7807 11.2201 9.5969 11.2952 9.44856 11.4455C9.30023 11.5957 9.22606 11.7818 9.22606 12.0039C9.22606 12.2259 9.29994 12.4098 9.44769 12.5554C9.59542 12.7011 9.77952 12.7739 9.99999 12.7739ZM9.99999 15.7739H14C14.2187 15.7739 14.4033 15.6996 14.5539 15.5508C14.7046 15.4021 14.7799 15.2178 14.7799 14.9979C14.7799 14.7764 14.7046 14.5913 14.554 14.4429C14.4034 14.2944 14.2188 14.2201 14 14.2201H9.99999C9.7807 14.2201 9.5969 14.2952 9.44856 14.4455C9.30023 14.5957 9.22606 14.7818 9.22606 15.0039C9.22606 15.2259 9.29994 15.4098 9.44769 15.5554C9.59542 15.7011 9.77952 15.7739 9.99999 15.7739Z"
                fill="#6F767E" />
            </svg>
          </div>
