		...
		<div class="content-body">
			<div class="page-titles">
				...
				<ul class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="javascript:void(0)">Basic DataTable</a></li>
				</ul>
			</div>
			<div class="container">
				<!-- row -->
				<div class="element-wrapper">
					<div class="element-right">
						<div class="p-4 border-bottom">
							...
							<p>Make use of Datatabls's unique Datatabls styles to enhance actions in forms, dialogs, and
								various other elements, featuring comprehensive support.</p>
							<a href="javascript:void(0);" class="btn btn-primary">Datatabls</a>
						</div>
						<div class="demo-right-inner" id="right-sidebar">
							...
							<div class="demo-right-tabs" id="rightSidebarScroll">
								<ul class="navbar-nav nav" id="menu-bar">
									...
									<li><a href="#accordion-six" class="scroll ">Responsive Datatable</a></li>
							...
							<div class="col-xl-12">
								<div class="card dz-card" id="accordion-six">
										...
										<ul class="nav nav-tabs dzm-tabs" id="myTab-six" role="tablist">
											...
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-six" data-bs-toggle="tab"
													data-bs-target="#responsive-html" type="button" role="tab"
													aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									...
									<div class="tab-content" id="myTabContent-six">
										...
										<div class="tab-pane fade " id="responsive-html" role="tabpanel"
											aria-labelledby="home-tab-six">
											<div class="card-body pt-0 p-0 code-area">
												<pre class="mb-0"><code class="language-html">
 &lt;div class="table-responsive"&gt;
												...
												<div class="table-responsive">
													<table id="example3" class="display table" style="min-width: 845px">
														...
														<tbody>
															...
															<tr>
																<td><img class="rounded-circle" width="35"
																		src="{{ asset('images/profile/small/pic10.jpg') }}" alt="">
																</td>
																<td>Sonya Frost</td>
																<td>Software Engineer</td>
																<td>Male</td>
