...
@section('content')
        <div class="content-body badge-demo">
			<div class="page-titles">
				<h5 class="dashboard_bar">Badge</h5>
				<ul class="breadcrumb">
				...
				<div class="element-wrapper">
					<div class="element-right ">
						<div class="p-4 border-bottom">
							<h2>Badge.</h2>
							<p>Make use of Bootstrap's unique Badge styles to enhance actions in forms, dialogs, and various other elements, featuring comprehensive support for multiple sizes, states, and additional functionalities.</p>
							<a href="javascript:void(0);" class="btn btn-primary">Badge on Bootstrap</a>
						</div>		
                        <div class="demo-right-inner dz-scroll " id="right-sidebar">
							...
							<div class="demo-right-tabs" id="rightSidebarScroll">
								<ul class="navbar-nav" id="menu-bar">
									...
									<li><a href="#badge-position" class="scroll">Badge Position</a></li>
									<li><a href="#badge-button" class="scroll">Badge Button</a></li>
	...
	&lt;/div&gt;</code></pre>
								...
								<!-- Column  -->  
								<div class="col-lg-12">
									<div class="card dz-card" id="badge-position">
										<div class="card-header flex-wrap d-flex justify-content-between border-0 ">
											<div>
											...
											<ul class="nav nav-tabs dzm-tabs" id="myTab-13" role="tablist">
												<li class="nav-item" role="presentation">
													<button class="nav-link active " id="home-tab-13" data-bs-toggle="tab" data-bs-target="#BadgePostion" type="button" role="tab"  aria-selected="true">Preview</button>
												</li>
												<li class="nav-item" role="presentation">
													<button class="nav-link " id="profile-tab-13" data-bs-toggle="tab" data-bs-target="#BadgePostion-html" type="button" role="tab"  aria-selected="false">HTML</button>
												</li>
											</ul>		
										</div>
										<div class="tab-content" id="myTabContent-13">
											<div class="tab-pane fade show active " id="BadgePostion" role="tabpanel" aria-labelledby="home-tab-13">
												<div class="card-body pt-0">
													<div class="bootstrap-badge">
											...
											<div class="tab-pane fade  " id="BadgePostion-html" role="tabpanel" aria-labelledby="home-tab-13">
												<div class="card-body p-0 code-area">
													<pre class="m-0"><code class="language-html">
	&lt;div class="bootstrap-badge"&gt;
		&lt;a href="javascript:void(0)" class="badge badge-primary position-relative me-4"&gt;Inbox
	...
	&lt;/div&gt;</code></pre>
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="badge-button">
										<div class="card-header flex-wrap d-flex justify-content-between border-0 ">
											<div>
												<h4 class="card-title">Badge With Button</h4>
												<p class="mb-0 subtitle">add <code>.btn</code> to change the style</p>
											</div>		
											<ul class="nav nav-tabs dzm-tabs" id="myTab-14" role="tablist">
												<li class="nav-item" role="presentation">
													<button class="nav-link active " id="home-tab-14" data-bs-toggle="tab" data-bs-target="#Badgebutton" type="button" role="tab"  aria-selected="true">Preview</button>
												</li>
												<li class="nav-item" role="presentation">
													<button class="nav-link " id="profile-tab-14" data-bs-toggle="tab" data-bs-target="#Badgebutton-html" type="button" role="tab"  aria-selected="false">HTML</button>
												</li>
											</ul>		
										</div>
										<div class="tab-content" id="myTabContent-14">
											<div class="tab-pane fade show active " id="Badgebutton" role="tabpanel" aria-labelledby="home-tab-14">
												<div class="card-body pt-0">
													<div class="bootstrap-badge">
											...
											<div class="tab-pane fade  " id="Badgebutton-html" role="tabpanel" aria-labelledby="home-tab-14">
												<div class="card-body p-0 code-area">
													<pre class="m-0"><code class="language-html">
	&lt;div class="bootstrap-badge"&gt;
