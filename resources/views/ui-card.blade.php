...
@section('content')
		<div class="content-body">
			<div class="page-titles">
				<h5 class="dashboard_bar">Card</h5>
				<ul class="breadcrumb">
				...
				<div class="element-wrapper">
					<div class="element-right ">
						<div class="p-4 border-bottom">
							...
							<a href="javascript:void(0);" class="btn btn-primary">Card on Bootstrap</a>
						</div>
...
&lt;/div&gt;</code></pre>
								...
								<div class="col-xl-12">
									<div class="card dz-card" id="card-title-2">
										<div class="card-header border-0 flex-wrap border-0>
											<h5 class=" card-title">Card title</h5>
											<ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
												<li class="nav-item" role="presentation">
													<button class="nav-link active " id="home-tab-1"
														data-bs-toggle="tab" data-bs-target="#CardTitle2" type="button"
										...
										<div class="tab-content" id="myTabContent-1">
											<div class="tab-pane fade show active" id="CardTitle2" role="tabpanel"
												...
												<div class="card-body pt-0">
													<p class="card-text">This is a wider card with supporting text and
														below
								...
								<div class="card dz-card text-center" id="card-title-3">
									...
									<div class="tab-content" id="myTabContent-2">
										<div class="tab-pane fade show active" id="CardTitle3" role="tabpanel"
											...
											<div class="card-body pt-0">
												<p class="card-text">This is a wider card with supporting text and below
								...
								<div class="card dz-card text-white" id="primary-card">
									...
									<div class="tab-content" id="myTabContent-5">
										<div class="tab-pane fade show active" id="Primarycard" role="tabpanel"
											...
											<div class="card-footer bg-transparent border-0 text-white">Last updateed 3
												min ago
											</div>
										</div>
...
&lt;/div&gt;</code></pre>
									...
									<div class="tab-content" id="myTabContent-11">
										<div class="tab-pane fade show active" id="Lightcard" role="tabpanel"
											...
											<div class="card-body pt-0 mb-0">
												<p class="card-text">Some quick example text to build on the card title
													and make up the bulk of the card's content.</p><a
													href="javascript:void(0);" class="btn btn-light btn-card">Go
													somewhere</a>
											</div>
    ...
    &lt;/div&gt;
    &lt;div class="card-body mb-0"&gt;
        &lt;p class="card-text"&gt;Some quick example text to build on the card title and make up the bulk of the card's content.&lt;/p&gt;&lt;a href="javascript:void(0);" class="btn btn-outline-light btn-card"&gt;Go
            somewhere&lt;/a&gt;
    &lt;/div&gt;
    &lt;div class="card-footer bg-transparent border-0"&gt;Last updateed 3 min ago
    &lt;/div&gt;
										...
										<div class="tab-pane fade show active" id="Darkcard" role="tabpanel"
											...
											<div class="card-body pt-0 mb-0">
												...
												<a href="javascript:void(0);"
													class="btn btn-dark text-white btn-card">Go
													somewhere</a>
											</div>
											<div class="card-footer bg-transparent border-0 text-white">Last updateed 3
												min ago
								...
								<div class="card dz-card overflow-hidden" id="card-title-5">
									...
									<div class="tab-content" id="myTabContent-14">
										<div class="tab-pane fade show active" id="CardTitle5" role="tabpanel"
											...
											<div class="card-body pt-0">
												<p class="card-text">He lay on his armour-like back, and if he lifted
													his head a little
												</p>
											</div>
											<div class="card-footer">
								...
								<div class="card dz-card" id="card-title-6">
									...
									<div class="tab-content" id="myTabContent-15">
										<div class="tab-pane fade show active" id="CardTitle6" role="tabpanel"
											...
											<img class="card-img-bottom img-fluid" src="{{ asset('images/card/3.png') }}"
												alt="Card image cap">
											<div class="card-footer">
												<p class="card-text d-inline">Card footer</p>
												<a href="javascript:void(0);" class="card-link float-end">Card link</a>
