...
@section('content')
        <div class="content-body">
			<div class="page-titles">
				<h5 class="dashboard_bar">Progressbar</h5>
				<ul class="breadcrumb">
				...
				<div class="element-wrapper">
					<div class="element-right ">
						<div class="p-4 border-bottom">
							...
							<a href="javascript:void(0);" class="btn btn-primary">Progressbar on Bootstrap</a>
						</div>	
									...
									<div class="card dz-card" id="skill-bars">
										...
										<div class="tab-content" id="myTabContent10">
											<div class="tab-pane fade show active" id="SkillBars" role="tabpanel" aria-labelledby="home-tab10">
												<div class="card-body pt-0">
													<h6 class="d-flex">Photoshop
														<span class="pull-end ms-auto">85%</span>
													</h6>
													<div class="progress ">
													...
													<h6 class="mt-4 d-flex">Code editor
														<span class="pull-end ms-auto">90%</span>
													</h6>
													<div class="progress">
													...
													<h6 class="mt-4 d-flex">Illustrator
														<span class="pull-end ms-auto">65%</span>
													</h6>
													<div class="progress">
