								...
								<div class="card">
									<div class="card-body">
										<div class="profile-interest">
											<h5 class="text-primary d-inline px-1">Interest</h5>
										...
										<div class="profile-news">
											...
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-black">Compete this projects</a></h5>
											...
											<div class="media pt-3 pb-3">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-black">Development planning</a></h5>
													<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
											<div class="media pt-3 pb-0">
												...
												<div class="media-body">
													<h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-black">Software planning</a></h5>
													<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
												</div>
											</div>
										</div>
                                        ...
                                        <div class="tab-content">
                                            <div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-3">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
														...
														<a class="post-title" href="post-details"><h3 class="text-black">Lorem Ipsum is simply dummy text.</h3></a>
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
														...
														<a class="post-title" href="post-details"><h3 class="text-black"> Lorem Ipsum has been the industry's standard.</h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button class="btn btn-primary me-2"><span class="me-2"><i
                                                                    class="fa fa-heart"></i></span>Like</button>
                                                    ...
                                                    <div class="profile-uoloaded-post">
                                                        <img src="{{ asset('images/profile/8.jpg') }}" alt="" class="img-fluid w-100 rounded">
														<a class="post-title" href="post-details"><h3 class="text-black">Collection of textile samples lay spread</h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button class="btn btn-primary me-2"><span class="me-2"><i
                                                                    class="fa fa-heart"></i></span>Like</button>
                                            ...
                                            <div id="about-me" class="tab-pane fade">
                                                ...
                                                <div class="profile-skills mb-5">
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-primary light mb-1">Admin</a>
                                                    <a href="javascript:void(0);" class="btn btn-primary light mb-1">Dashboard</a>
                                                    <a href="javascript:void(0);" class="btn btn-primary light mb-1">Photoshop</a>
                                                    <a href="javascript:void(0);" class="btn btn-primary light mb-1">Bootstrap</a>
                                                    <a href="javascript:void(0);" class="btn btn-primary light mb-1">Responsive</a>
                                                    <a href="javascript:void(0);" class="btn btn-primary light mb-1">Crypto</a>
                                                </div>
