...
@section('content')
        <div class="content-body">
			<div class="page-titles">
				<h5 class="dashboard_bar">Accordion</h5>
				<ul class="breadcrumb">
				...
				<div class="element-wrapper">
					<div class="element-right ">
						<div class="p-4 border-bottom">
							<h2>Accordion.</h2>
							<p>Make use of Bootstrap's unique Accordion styles to enhance actions in forms, dialogs, and various other elements, featuring comprehensive support for multiple sizes, states, and additional functionalities.</p>
							<a href="javascript:void(0);" class="btn btn-primary">Accordion on Bootstrap</a>
						</div>	
						<div class="demo-right-inner navigation navbar" id="right-sidebar">
							...
							<div class="demo-right-tabs" id="rightSidebarScroll">
								<ul class="navbar-nav nav" id="menu-bar">
									<li><a href="#accordion-basic" class="scroll ">Basic Accordion</a></li>
									<li><a href="#accordion-alwaysopen" class="scroll ">Always Open Accordion</a></li>
									...
									<li><a href="#accordion-five" class="scroll">Accordion indicator in Right position</a></li>
					...
					<div class="demo-view">
						<div class="container-fluid">
							<div class="row">
								<!-- Column Starts -->
							<div class="col-xl-12">
								<div class="card dz-card" id="accordion-basic">
									<div class="card-header flex-wrap border-0 pb-2">
										<div>
											<h4 class="card-title">Basic Accordion</h4>
											<p class="m-0 subtitle">Basic accordion. Add <code>accordion</code> class in root</p>
										</div>
										<ul class="nav nav-tabs dzm-tabs" id="myTab-13" role="tablist">
											<li class="nav-item" role="presentation">
												<button class="nav-link active " id="home-tab-first" data-bs-toggle="tab" data-bs-target="#BasicPreview" type="button" role="tab"  aria-selected="true">Preview</button>
											</li>
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-first" data-bs-toggle="tab" data-bs-target="#Basichtml" type="button" role="tab"  aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									<div class="tab-content" id="myTabContent-13">
										<div class="tab-pane fade show active" id="BasicPreview" role="tabpanel" aria-labelledby="home-tab-first">
											<div class="card-body">
												<div class="accordion accordion-default" id="accordionExample">
										...
										<div class="tab-pane fade " id="Basichtml" role="tabpanel" aria-labelledby="home-tab-first">
...
<pre class="mb-0"><code class="language-html">
	...
	<!-- /Default accordion -->	
							...
							<!-- Column Starts -->
							<div class="col-xl-12">
								<div class="card dz-card" id="accordion-alwaysopen">
									<div class="card-header flex-wrap border-0 pb-2">
										<div>
											<h4 class="card-title">Always Open Accordion</h4>
											<p class="m-0 subtitle">Omit <code>data-bs-parent</code> attribute on each</p>
										</div>
										<ul class="nav nav-tabs dzm-tabs" id="myTab-14" role="tablist">
											<li class="nav-item" role="presentation">
												<button class="nav-link active " id="home-tab-second" data-bs-toggle="tab" data-bs-target="#alwaysopen" type="button" role="tab"  aria-selected="true">Preview</button>
											</li>
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-second" data-bs-toggle="tab" data-bs-target="#alwaysopen-html" type="button" role="tab"  aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									<div class="tab-content" id="myTabContent-14">
										<div class="tab-pane fade show active" id="alwaysopen" role="tabpanel" aria-labelledby="home-tab-second">
											<div class="card-body">
										...
										<div class="tab-pane fade " id="alwaysopen-html" role="tabpanel" aria-labelledby="home-tab-second">
											<div class="card-body pt-0 p-0 code-area">
	<!-- Default accordion -->
<pre class="mb-0"><code class="language-html">
		...
		&lt;/div&gt;
					...
					<div class="col-xl-12">
						<div class="card dz-card" id="accordion-five">
							<div class="card-header flex-wrap d-flex justify-content-between  border-0 pb-2">
								<div>
									<h4 class="card-title">Accordion indicator in right position</h4>
