...
@section('content')
		<div class="content-body chat-height">
			<div class="page-titles">
				<h5 class="dashboard_bar">Chat</h5>
				<ul class="breadcrumb">
									...
									<div class="row gx-0">
										...
										<div class="col-xl-3 col-lg-6 col-sm-5 chat-border mobile-chat chat-left-area">
											<div class="chat-p shaprate">
												<div class="d-flex align-items-center">
													<img src="{{ asset('images/contacts/d1.jpg') }}"
												...
												<div class="input-group search-area">
													...
													<span class="input-group-text"><a href="javascript:void(0)">
															<svg width="18" height="19" viewBox="0 0 18 19" fill="none"
																xmlns="http://www.w3.org/2000/svg">
																<circle cx="8.82495" cy="9.32491" r="6.74142"
																	stroke="#252525" stroke-linecap="round"
																	stroke-linejoin="round" />
																<path d="M13.5137 14.3638L16.1568 16.9999"
																	stroke="#252525" stroke-linecap="round"
																	stroke-linejoin="round" />
															</svg>
														</a></span>
											...
											<div class="people-list dz-scroll">
												...
												<div class="chat-p style-1">
													<div class="d-flex active">
														<img src="{{ asset('images/contacts/d4.jpg') }}"
															class="avatar avatar-md rounded-circle" alt="">
														<div class="ms-2">
												...
												<div class="chat-p style-1">
													<div class="d-flex">
														<img src="{{ asset('images/contacts/d2.jpg') }}"
															class="avatar avatar-md rounded-circle" alt="">
														<div class="ms-2">
										...
										<div class="col-xl-5 col-lg-6 col-sm-7 chat-border">
													...
													<div class="ms-2">
														...
														<span>
															<svg width="14" height="14" viewBox="0 0 14 14" fill="none"
																xmlns="http://www.w3.org/2000/svg">
																<circle cx="7" cy="7" r="6" fill="#3AC977"
											...
											<div class="chat-box-area style-2 dz-scroll" id="chartBox2">
												<span class="text-center d-block mb-4">25/04/2024</span>
													...
													<div class="message-received w-auto">
														<div class="d-flex">
															...
															<div class="ms-1 text">
																...
																<p class="mb-3">Can you arrange schedule for next
																	meeting?</p>
																<span>12:45 PM</span>
															</div>
														</div>
												...
												<div class="media justify-content-end align-items-end ms-auto">
													<div class="message-sent w-auto">
														...
														<p class="mb-1">Okay, I’ll arrange it soon. i noftify you when
														</p>
														<p class="mb-1">Very Good morning</p>
											...
											<div class="message-send style-2">
												...
												<button type="button"
													class="btn btn-primary  p-2 d-flex align-items-center">
													Send
													<svg class="ms-1" width="16" height="16" viewBox="0 0 16 16"
										...
										<div class="col-xl-4 file-media dz-scroll">
											<div class="chat-meadia">
												...
												<ul class="image-list">
													<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/1.png') }}"
																alt=""></a></li>
													<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/3.png') }}"
																alt=""></a></li>
													<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/2.png') }}"
																alt=""></a></li>
													<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/5.png') }}"
																alt=""></a></li>
													<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/4.png') }}"
																alt=""></a></li>
													<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/2.png') }}"
																alt=""></a></li>
													<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/4.png') }}"
													...
													<li><a href="javascript:void(0);"><img src="{{ asset('images/chat/2.png') }}"
																alt=""></a></li>
													<li class="all-media"><a
															href="javascript:void(0);"><span>50+</span><img
																src="{{ asset('images/chat/5.png') }}" alt=""></a></li>
												</ul>
											</div>
											<div class="chat-meadia">
												...
												<div class="file-list row">
													...
													<div class="text-center col-xl-4 col-6 filie-l-icon">
														<img src="{{ asset('images/chat/google-docs1.png') }}" alt="">
														<h5>document.doc</h5>
														<small>Size:6MB</small>
													</div>
													<div class="text-center col-xl-4 col-6 filie-l-icon">
														<img src="{{ asset('images/chat/play-button1.png') }}" alt="">
														<h5>File.mp4</h5>
														<small>Size:1GB</small>
													</div>
													<div class="text-center col-xl-4 col-6 filie-l-icon">
														<img src="{{ asset('images/chat/music-notes1.png') }}" alt="">
														<h5>File.mp4</h5>
