...
@section('content')
        <div class="content-body">
			<div class="page-titles">
				<h5 class="dashboard_bar">Widget</h5>
				<ul class="breadcrumb">
            ...
            <div class="container">
                ...
                <div class="row">
					...
					<div class="col-xl-8 col-xxl-8 col-lg-12 col-sm-12">
                        <div id="user-activity" class="card h-auto">
                            ...
                            <div class="card-body pt-0">
                                <div class="list-group-flush mt-4">
                                    <div class="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 fw-semi-bold border-top-0">
                                        <p class="mb-0 text-black">Top Active Pages</p>
                                        <p class="mb-0 text-black">Active Users</p>
                                    </div>
					...
					<div class="col-xl-4 col-lg-12 col-sm-12">
						<div class="card overflow-hidden">
							...
							<ul class="list-group list-group-flush">
								<li class="list-group-item d-flex justify-content-between"><span class="mb-0 text-black">Patient Gender</span> <strong class="">Female	</strong></li>
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown custom-dropdown mb-0">
                                                        <div class="btn sharp btn-primary tp-btn" data-bs-toggle="dropdown">
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><circle fill="#fff" cx="12" cy="5" r="2"/><circle fill="#fff" cx="12" cy="12" r="2"/><circle fill="#fff" cx="12" cy="19" r="2"/></g></svg>
														</div>
														<div class="dropdown-menu dropdown-menu-end">
