										...
										<div class="cm-content-body form excerpt border-top">
											<div class="card-body ItemsCheckboxSec p-sm-4">
												...
												<div class="tab-content" id="myTabContent">
													...
													<a  class="btn btn-primary dz-menu-btn">Add to Menu</a>
												</div>
											</div>
										</div>
									</div>
																...
																<div class="row">
																	<div class="col-xl-12">
																		<div class="mb-3">
																			...
																			<input type="text" class="form-control solid" placeholder="https://bodyclub.dexignzone.com/xhtml/about-us.html">
																		</div>
																	</div>
																	<div class="col-xl-6">
																		<div class="mb-3">
